...
import {padding, borderRadius, margin} from 'src/components/config/spacing';
  ...
  showButtonAdd = (item, theme) => {
    ...
    return (
      <Quantity
        ...
        style={{backgroundColor: theme.colors.support.bgColor}}
      />
    );
  };
  render() {
              ...
              {data.map((p, index) => (
                <View
                  ...
                  style={[
                    ...
                    index < data.size - 1 && styles.itemBorder,
                  ]}>
