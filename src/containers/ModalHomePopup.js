        ...
        style && typeof style === 'object' && !isEqual(style, {})
          ? size
            ? {
                ...style,
                lineHeight:
                  parseInt(style.fontSize, 0) > sizes[size]
                    ? parseInt(style.fontSize, 0) * 1.3
                    : lineHeights[size],
              }
            : style
          : {};
...
class ModalHomePopup extends React.Component {
  ...
  renderTitleText = () => {
    ...
    const size =
      dataText.style && dataText.style.fontSize
        ...
        : sizes.h6;
    const minHeightBadge = parseInt((26 * size) / sizes.h6, 0);
  ...
  renderDescriptionText = () => {
    ...
    const lineHeight =
      dataText.style && dataText.style.fontSize
        ? parseInt((25 * dataText.style.fontSize) / sizes.h5, 0)
        : 25;
    return (
      <Text
        style={[
